  ...
  return (
    <div className="flex flex-col min-h-screen">
      <header
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.8)), url('/assets/background.jpg')",
        ...
        <div className="container mx-auto px-4 z-10 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl font-bold mb-4">
              Alubijid East District Community Learning Center Student
              Information System
            </h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button
                className="bg-blue-600 hover:bg-blue-700 w-32 h-auto text-lg
"
              >
                Get Started
              </Button>
